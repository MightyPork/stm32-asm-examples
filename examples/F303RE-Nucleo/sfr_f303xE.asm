...
; ==== STM32F303xE PERIPHERALS ===============================
;
; CTU Prague, FEL, Department of Measurement
;
; ------------------------------------------------------------
;
; Generated from "STM32F303xE.svd"
;
...
; GPIOG base address:
GPIOG_BASE                     EQU 0x48001800

; GPIOG registers:

GPIOG_MODER                    EQU (GPIOG_BASE + 0x0) ; GPIO port mode register
GPIOG_OTYPER                   EQU (GPIOG_BASE + 0x4) ; GPIO port output type register
GPIOG_OSPEEDR                  EQU (GPIOG_BASE + 0x8) ; GPIO port output speed register
GPIOG_PUPDR                    EQU (GPIOG_BASE + 0xc) ; GPIO port pull-up/pull-down register
GPIOG_IDR                      EQU (GPIOG_BASE + 0x10) ; GPIO port input data register
GPIOG_ODR                      EQU (GPIOG_BASE + 0x14) ; GPIO port output data register
GPIOG_BSRR                     EQU (GPIOG_BASE + 0x18) ; GPIO port bit set/reset register
GPIOG_LCKR                     EQU (GPIOG_BASE + 0x1c) ; GPIO port configuration lock register
GPIOG_AFRL                     EQU (GPIOG_BASE + 0x20) ; GPIO alternate function low register
GPIOG_AFRH                     EQU (GPIOG_BASE + 0x24) ; GPIO alternate function high register
GPIOG_BRR                      EQU (GPIOG_BASE + 0x28) ; Port bit reset register
; Fields the same as in the first instance.
...
; GPIOH base address:
GPIOH_BASE                     EQU 0x48001c00

; GPIOH registers:

GPIOH_MODER                    EQU (GPIOH_BASE + 0x0) ; GPIO port mode register
GPIOH_OTYPER                   EQU (GPIOH_BASE + 0x4) ; GPIO port output type register
GPIOH_OSPEEDR                  EQU (GPIOH_BASE + 0x8) ; GPIO port output speed register
GPIOH_PUPDR                    EQU (GPIOH_BASE + 0xc) ; GPIO port pull-up/pull-down register
GPIOH_IDR                      EQU (GPIOH_BASE + 0x10) ; GPIO port input data register
GPIOH_ODR                      EQU (GPIOH_BASE + 0x14) ; GPIO port output data register
GPIOH_BSRR                     EQU (GPIOH_BASE + 0x18) ; GPIO port bit set/reset register
GPIOH_LCKR                     EQU (GPIOH_BASE + 0x1c) ; GPIO port configuration lock register
GPIOH_AFRL                     EQU (GPIOH_BASE + 0x20) ; GPIO alternate function low register
GPIOH_AFRH                     EQU (GPIOH_BASE + 0x24) ; GPIO alternate function high register
GPIOH_BRR                      EQU (GPIOH_BASE + 0x28) ; Port bit reset register
; Fields the same as in the first instance.
...
RCC_CFGR_PLLSRC                EQU 0x00018000 ; PLL entry clock source
...
TIM4_CR1_UIFREMAP              EQU 0x00000800 ; UIF status bit remapping
TIM4_CR1_UIFREMAP_ofs          EQU 11
TIM4_CR1_UIFREMAP_len          EQU 1
...
TIM4_SMCR_SMS_3                EQU 0x00010000 ; Slave mode selection bit3
TIM4_SMCR_SMS_3_ofs            EQU 16
TIM4_SMCR_SMS_3_len            EQU 1
...
TIM4_CCMR1_Output_OC1M_3       EQU 0x00010000 ; Output compare 1 mode bit 3
TIM4_CCMR1_Output_OC1M_3_ofs   EQU 16
TIM4_CCMR1_Output_OC1M_3_len   EQU 1
TIM4_CCMR1_Output_OC2M_3       EQU 0x01000000 ; Output compare 2 mode bit 3
TIM4_CCMR1_Output_OC2M_3_ofs   EQU 24
TIM4_CCMR1_Output_OC2M_3_len   EQU 1
...
TIM4_CCMR2_Output_O24CE        EQU 0x00008000 ; Output compare 4 clear enable
TIM4_CCMR2_Output_O24CE_ofs    EQU 15
TIM4_CCMR2_Output_O24CE_len    EQU 1
TIM4_CCMR2_Output_OC3M_3       EQU 0x00010000 ; Output compare 3 mode bit3
TIM4_CCMR2_Output_OC3M_3_ofs   EQU 16
TIM4_CCMR2_Output_OC3M_3_len   EQU 1
TIM4_CCMR2_Output_OC4M_3       EQU 0x01000000 ; Output compare 4 mode bit3
TIM4_CCMR2_Output_OC4M_3_ofs   EQU 24
TIM4_CCMR2_Output_OC4M_3_len   EQU 1
...
TIM4_CCER_CC1NP                EQU 0x00000008 ; Capture/Compare 1 output Polarity
TIM4_CCER_CC1NP_ofs            EQU 3
TIM4_CCER_CC1NP_len            EQU 1
...
TIM4_CCER_CC2NP                EQU 0x00000080 ; Capture/Compare 2 output Polarity
TIM4_CCER_CC2NP_ofs            EQU 7
TIM4_CCER_CC2NP_len            EQU 1
...
TIM4_CCER_CC3NP                EQU 0x00000800 ; Capture/Compare 3 output Polarity
TIM4_CCER_CC3NP_ofs            EQU 11
TIM4_CCER_CC3NP_len            EQU 1
...
TIM4_CCER_CC4NP                EQU 0x00008000 ; Capture/Compare 3 output Polarity
TIM4_CCER_CC4NP_ofs            EQU 15
TIM4_CCER_CC4NP_len            EQU 1


; TIM4_CNT fields:

TIM4_CNT_CNTL                  EQU 0x0000ffff ; Low counter value
TIM4_CNT_CNTL_ofs              EQU 0
TIM4_CNT_CNTL_len              EQU 16
TIM4_CNT_CNTH                  EQU 0x7fff0000 ; High counter value
TIM4_CNT_CNTH_ofs              EQU 16
TIM4_CNT_CNTH_len              EQU 15
TIM4_CNT_CNT_or_UIFCPY         EQU 0x80000000 ; if IUFREMAP=0 than CNT with read write access else UIFCPY with read only access
TIM4_CNT_CNT_or_UIFCPY_ofs     EQU 31
TIM4_CNT_CNT_or_UIFCPY_len     EQU 1
...
TIM4_ARR_ARRL                  EQU 0x0000ffff ; Low Auto-reload value
TIM4_ARR_ARRL_ofs              EQU 0
TIM4_ARR_ARRL_len              EQU 16
TIM4_ARR_ARRH                  EQU 0xffff0000 ; High Auto-reload value
TIM4_ARR_ARRH_ofs              EQU 16
TIM4_ARR_ARRH_len              EQU 16


; TIM4_CCR1 fields:

TIM4_CCR1_CCR1L                EQU 0x0000ffff ; Low Capture/Compare 1 value
TIM4_CCR1_CCR1L_ofs            EQU 0
TIM4_CCR1_CCR1L_len            EQU 16
TIM4_CCR1_CCR1H                EQU 0xffff0000 ; High Capture/Compare 1 value (on TIM2)
TIM4_CCR1_CCR1H_ofs            EQU 16
TIM4_CCR1_CCR1H_len            EQU 16


; TIM4_CCR2 fields:

TIM4_CCR2_CCR2L                EQU 0x0000ffff ; Low Capture/Compare 2 value
TIM4_CCR2_CCR2L_ofs            EQU 0
TIM4_CCR2_CCR2L_len            EQU 16
TIM4_CCR2_CCR2H                EQU 0xffff0000 ; High Capture/Compare 2 value (on TIM2)
TIM4_CCR2_CCR2H_ofs            EQU 16
TIM4_CCR2_CCR2H_len            EQU 16


; TIM4_CCR3 fields:

TIM4_CCR3_CCR3L                EQU 0x0000ffff ; Low Capture/Compare value
TIM4_CCR3_CCR3L_ofs            EQU 0
TIM4_CCR3_CCR3L_len            EQU 16
TIM4_CCR3_CCR3H                EQU 0xffff0000 ; High Capture/Compare value (on TIM2)
TIM4_CCR3_CCR3H_ofs            EQU 16
TIM4_CCR3_CCR3H_len            EQU 16


; TIM4_CCR4 fields:

TIM4_CCR4_CCR4L                EQU 0x0000ffff ; Low Capture/Compare value
TIM4_CCR4_CCR4L_ofs            EQU 0
TIM4_CCR4_CCR4L_len            EQU 16
TIM4_CCR4_CCR4H                EQU 0xffff0000 ; High Capture/Compare value (on TIM2)
TIM4_CCR4_CCR4H_ofs            EQU 16
TIM4_CCR4_CCR4H_len            EQU 16
...
SPI_CR2_NSSP                   EQU 0x00000008 ; NSS pulse management
SPI_CR2_NSSP_ofs               EQU 3
SPI_CR2_NSSP_len               EQU 1
...
SPI_CR2_DS                     EQU 0x00000f00 ; Data size
SPI_CR2_DS_ofs                 EQU 8
SPI_CR2_DS_len                 EQU 4
SPI_CR2_FRXTH                  EQU 0x00001000 ; FIFO reception threshold
SPI_CR2_FRXTH_ofs              EQU 12
SPI_CR2_FRXTH_len              EQU 1
SPI_CR2_LDMA_RX                EQU 0x00002000 ; Last DMA transfer for reception
SPI_CR2_LDMA_RX_ofs            EQU 13
SPI_CR2_LDMA_RX_len            EQU 1
SPI_CR2_LDMA_TX                EQU 0x00004000 ; Last DMA transfer for transmission
SPI_CR2_LDMA_TX_ofs            EQU 14
SPI_CR2_LDMA_TX_len            EQU 1
...
SPI_SR_FRLVL_ofs               EQU 9
SPI_SR_FRLVL_len               EQU 2
SPI_SR_FTLVL                   EQU 0x00001800 ; FIFO transmission level
SPI_SR_FTLVL_ofs               EQU 11
SPI_SR_FTLVL_len               EQU 2
...
SPI3_I2SCFGR                   EQU (SPI3_BASE + 0x1c) ; I2S configuration register
SPI3_I2SPR                     EQU (SPI3_BASE + 0x20) ; I2S prescaler register
; Fields the same as in the first instance.
...
; USB_FS_USB_EP0R fields: (all endpoints the same)

USB_FS_USB_EPnR_EA             EQU 0x0000000f ; Endpoint address
USB_FS_USB_EPnR_EA_ofs         EQU 0
USB_FS_USB_EPnR_EA_len         EQU 4
USB_FS_USB_EPnR_STAT_TX        EQU 0x00000030 ; Status bits, for transmission transfers
USB_FS_USB_EPnR_STAT_TX_ofs    EQU 4
USB_FS_USB_EPnR_STAT_TX_len    EQU 2
USB_FS_USB_EPnR_DTOG_TX        EQU 0x00000040 ; Data Toggle, for transmission transfers
USB_FS_USB_EPnR_DTOG_TX_ofs    EQU 6
USB_FS_USB_EPnR_DTOG_TX_len    EQU 1
USB_FS_USB_EPnR_CTR_TX         EQU 0x00000080 ; Correct Transfer for transmission
USB_FS_USB_EPnR_CTR_TX_ofs     EQU 7
USB_FS_USB_EPnR_CTR_TX_len     EQU 1
USB_FS_USB_EPnR_EP_KIND        EQU 0x00000100 ; Endpoint kind
USB_FS_USB_EPnR_EP_KIND_ofs    EQU 8
USB_FS_USB_EPnR_EP_KIND_len    EQU 1
USB_FS_USB_EPnR_EP_TYPE        EQU 0x00000600 ; Endpoint type
USB_FS_USB_EPnR_EP_TYPE_ofs    EQU 9
USB_FS_USB_EPnR_EP_TYPE_len    EQU 2
USB_FS_USB_EPnR_SETUP          EQU 0x00000800 ; Setup transaction completed
USB_FS_USB_EPnR_SETUP_ofs      EQU 11
USB_FS_USB_EPnR_SETUP_len      EQU 1
USB_FS_USB_EPnR_STAT_RX        EQU 0x00003000 ; Status bits, for reception transfers
USB_FS_USB_EPnR_STAT_RX_ofs    EQU 12
USB_FS_USB_EPnR_STAT_RX_len    EQU 2
USB_FS_USB_EPnR_DTOG_RX        EQU 0x00004000 ; Data Toggle, for reception transfers
USB_FS_USB_EPnR_DTOG_RX_ofs    EQU 14
USB_FS_USB_EPnR_DTOG_RX_len    EQU 1
USB_FS_USB_EPnR_CTR_RX         EQU 0x00008000 ; Correct transfer for reception
USB_FS_USB_EPnR_CTR_RX_ofs     EQU 15
USB_FS_USB_EPnR_CTR_RX_len     EQU 1
...
; I2C3 base address:
I2C3_BASE                      EQU 0x40007800

; I2C3 registers:

I2C3_CR1                       EQU (I2C3_BASE + 0x0) ; Control register 1
I2C3_CR2                       EQU (I2C3_BASE + 0x4) ; Control register 2
I2C3_OAR1                      EQU (I2C3_BASE + 0x8) ; Own address register 1
I2C3_OAR2                      EQU (I2C3_BASE + 0xc) ; Own address register 2
I2C3_TIMINGR                   EQU (I2C3_BASE + 0x10) ; Timing register
I2C3_TIMEOUTR                  EQU (I2C3_BASE + 0x14) ; Status register 1
I2C3_ISR                       EQU (I2C3_BASE + 0x18) ; Interrupt and Status register
I2C3_ICR                       EQU (I2C3_BASE + 0x1c) ; Interrupt clear register
I2C3_PECR                      EQU (I2C3_BASE + 0x20) ; PEC register
I2C3_RXDR                      EQU (I2C3_BASE + 0x24) ; Receive data register
I2C3_TXDR                      EQU (I2C3_BASE + 0x28) ; Transmit data register
; Fields the same as in the first instance.
...
ADC_ISR_JQOVF                  EQU 0x00000400 ; JQOVF
ADC_ISR_JQOVF_ofs              EQU 10
ADC_ISR_JQOVF_len              EQU 1
ADC_ISR_AWD3                   EQU 0x00000200 ; AWD3
ADC_ISR_AWD3_ofs               EQU 9
ADC_ISR_AWD3_len               EQU 1
ADC_ISR_AWD2                   EQU 0x00000100 ; AWD2
ADC_ISR_AWD2_ofs               EQU 8
ADC_ISR_AWD2_len               EQU 1
ADC_ISR_AWD1                   EQU 0x00000080 ; AWD1
ADC_ISR_AWD1_ofs               EQU 7
ADC_ISR_AWD1_len               EQU 1
ADC_ISR_JEOS                   EQU 0x00000040 ; JEOS
ADC_ISR_JEOS_ofs               EQU 6
ADC_ISR_JEOS_len               EQU 1
ADC_ISR_JEOC                   EQU 0x00000020 ; JEOC
ADC_ISR_JEOC_ofs               EQU 5
ADC_ISR_JEOC_len               EQU 1
ADC_ISR_OVR                    EQU 0x00000010 ; OVR
ADC_ISR_OVR_ofs                EQU 4
ADC_ISR_OVR_len                EQU 1
ADC_ISR_EOS                    EQU 0x00000008 ; EOS
ADC_ISR_EOS_ofs                EQU 3
ADC_ISR_EOS_len                EQU 1
ADC_ISR_EOC                    EQU 0x00000004 ; EOC
ADC_ISR_EOC_ofs                EQU 2
ADC_ISR_EOC_len                EQU 1
ADC_ISR_EOSMP                  EQU 0x00000002 ; EOSMP
ADC_ISR_EOSMP_ofs              EQU 1
ADC_ISR_EOSMP_len              EQU 1
ADC_ISR_ADRDY                  EQU 0x00000001 ; ADRDY
...
ADC_IER_JQOVFIE                EQU 0x00000400 ; JQOVFIE
ADC_IER_JQOVFIE_ofs            EQU 10
ADC_IER_JQOVFIE_len            EQU 1
ADC_IER_AWD3IE                 EQU 0x00000200 ; AWD3IE
ADC_IER_AWD3IE_ofs             EQU 9
ADC_IER_AWD3IE_len             EQU 1
ADC_IER_AWD2IE                 EQU 0x00000100 ; AWD2IE
ADC_IER_AWD2IE_ofs             EQU 8
ADC_IER_AWD2IE_len             EQU 1
ADC_IER_AWD1IE                 EQU 0x00000080 ; AWD1IE
ADC_IER_AWD1IE_ofs             EQU 7
ADC_IER_AWD1IE_len             EQU 1
ADC_IER_JEOSIE                 EQU 0x00000040 ; JEOSIE
ADC_IER_JEOSIE_ofs             EQU 6
ADC_IER_JEOSIE_len             EQU 1
ADC_IER_JEOCIE                 EQU 0x00000020 ; JEOCIE
ADC_IER_JEOCIE_ofs             EQU 5
ADC_IER_JEOCIE_len             EQU 1
ADC_IER_OVRIE                  EQU 0x00000010 ; OVRIE
ADC_IER_OVRIE_ofs              EQU 4
ADC_IER_OVRIE_len              EQU 1
ADC_IER_EOSIE                  EQU 0x00000008 ; EOSIE
ADC_IER_EOSIE_ofs              EQU 3
ADC_IER_EOSIE_len              EQU 1
ADC_IER_EOCIE                  EQU 0x00000004 ; EOCIE
ADC_IER_EOCIE_ofs              EQU 2
ADC_IER_EOCIE_len              EQU 1
ADC_IER_EOSMPIE                EQU 0x00000002 ; EOSMPIE
ADC_IER_EOSMPIE_ofs            EQU 1
ADC_IER_EOSMPIE_len            EQU 1
ADC_IER_ADRDYIE                EQU 0x00000001 ; ADRDYIE
...
ADC_CR_ADCAL                   EQU 0x80000000 ; ADCAL
ADC_CR_ADCAL_ofs               EQU 31
ADC_CR_ADCAL_len               EQU 1
ADC_CR_ADCALDIF                EQU 0x40000000 ; ADCALDIF
ADC_CR_ADCALDIF_ofs            EQU 30
ADC_CR_ADCALDIF_len            EQU 1
ADC_CR_DEEPPWD                 EQU 0x20000000 ; DEEPPWD
ADC_CR_DEEPPWD_ofs             EQU 29
ADC_CR_DEEPPWD_len             EQU 1
ADC_CR_ADVREGEN                EQU 0x10000000 ; ADVREGEN
ADC_CR_ADVREGEN_ofs            EQU 28
ADC_CR_ADVREGEN_len            EQU 1
ADC_CR_JADSTP                  EQU 0x00000020 ; JADSTP
ADC_CR_JADSTP_ofs              EQU 5
ADC_CR_JADSTP_len              EQU 1
ADC_CR_ADSTP                   EQU 0x00000010 ; ADSTP
ADC_CR_ADSTP_ofs               EQU 4
ADC_CR_ADSTP_len               EQU 1
ADC_CR_JADSTART                EQU 0x00000008 ; JADSTART
ADC_CR_JADSTART_ofs            EQU 3
ADC_CR_JADSTART_len            EQU 1
ADC_CR_ADSTART                 EQU 0x00000004 ; ADSTART
ADC_CR_ADSTART_ofs             EQU 2
ADC_CR_ADSTART_len             EQU 1
ADC_CR_ADDIS                   EQU 0x00000002 ; ADDIS
ADC_CR_ADDIS_ofs               EQU 1
ADC_CR_ADDIS_len               EQU 1
ADC_CR_ADEN                    EQU 0x00000001 ; ADEN
...
ADC_CFGR_AWDCH1CH              EQU 0x7c000000 ; AWDCH1CH
ADC_CFGR_AWDCH1CH_ofs          EQU 26
ADC_CFGR_AWDCH1CH_len          EQU 5
ADC_CFGR_JAUTO                 EQU 0x02000000 ; JAUTO
ADC_CFGR_JAUTO_ofs             EQU 25
ADC_CFGR_JAUTO_len             EQU 1
ADC_CFGR_JAWD1EN               EQU 0x01000000 ; JAWD1EN
ADC_CFGR_JAWD1EN_ofs           EQU 24
ADC_CFGR_JAWD1EN_len           EQU 1
ADC_CFGR_AWD1EN                EQU 0x00800000 ; AWD1EN
ADC_CFGR_AWD1EN_ofs            EQU 23
ADC_CFGR_AWD1EN_len            EQU 1
ADC_CFGR_AWD1SGL               EQU 0x00400000 ; AWD1SGL
ADC_CFGR_AWD1SGL_ofs           EQU 22
ADC_CFGR_AWD1SGL_len           EQU 1
ADC_CFGR_JQM                   EQU 0x00200000 ; JQM
ADC_CFGR_JQM_ofs               EQU 21
ADC_CFGR_JQM_len               EQU 1
ADC_CFGR_JDISCEN               EQU 0x00100000 ; JDISCEN
ADC_CFGR_JDISCEN_ofs           EQU 20
ADC_CFGR_JDISCEN_len           EQU 1
ADC_CFGR_DISCNUM               EQU 0x000e0000 ; DISCNUM
ADC_CFGR_DISCNUM_ofs           EQU 17
ADC_CFGR_DISCNUM_len           EQU 3
ADC_CFGR_DISCEN                EQU 0x00010000 ; DISCEN
ADC_CFGR_DISCEN_ofs            EQU 16
ADC_CFGR_DISCEN_len            EQU 1
ADC_CFGR_AUTOFF                EQU 0x00008000 ; AUTOFF
ADC_CFGR_AUTOFF_ofs            EQU 15
ADC_CFGR_AUTOFF_len            EQU 1
ADC_CFGR_AUTDLY                EQU 0x00004000 ; AUTDLY
ADC_CFGR_AUTDLY_ofs            EQU 14
ADC_CFGR_AUTDLY_len            EQU 1
ADC_CFGR_CONT                  EQU 0x00002000 ; CONT
ADC_CFGR_CONT_ofs              EQU 13
ADC_CFGR_CONT_len              EQU 1
ADC_CFGR_OVRMOD                EQU 0x00001000 ; OVRMOD
ADC_CFGR_OVRMOD_ofs            EQU 12
ADC_CFGR_OVRMOD_len            EQU 1
ADC_CFGR_EXTEN                 EQU 0x00000c00 ; EXTEN
ADC_CFGR_EXTEN_ofs             EQU 10
ADC_CFGR_EXTEN_len             EQU 2
ADC_CFGR_EXTSEL                EQU 0x000003c0 ; EXTSEL
ADC_CFGR_EXTSEL_ofs            EQU 6
ADC_CFGR_EXTSEL_len            EQU 4
ADC_CFGR_ALIGN                 EQU 0x00000020 ; ALIGN
ADC_CFGR_ALIGN_ofs             EQU 5
ADC_CFGR_ALIGN_len             EQU 1
ADC_CFGR_RES                   EQU 0x00000018 ; RES
ADC_CFGR_RES_ofs               EQU 3
ADC_CFGR_RES_len               EQU 2
ADC_CFGR_DMACFG                EQU 0x00000002 ; DMACFG
ADC_CFGR_DMACFG_ofs            EQU 1
ADC_CFGR_DMACFG_len            EQU 1
ADC_CFGR_DMAEN                 EQU 0x00000001 ; DMAEN
ADC_CFGR_DMAEN_ofs             EQU 0
ADC_CFGR_DMAEN_len             EQU 1


; ADC1_SMPR1 fields:

ADC_SMPR1_SMP9                 EQU 0x38000000 ; SMP9
ADC_SMPR1_SMP9_ofs             EQU 27
ADC_SMPR1_SMP9_len             EQU 3
ADC_SMPR1_SMP8                 EQU 0x07000000 ; SMP8
ADC_SMPR1_SMP8_ofs             EQU 24
ADC_SMPR1_SMP8_len             EQU 3
ADC_SMPR1_SMP7                 EQU 0x00e00000 ; SMP7
ADC_SMPR1_SMP7_ofs             EQU 21
ADC_SMPR1_SMP7_len             EQU 3
ADC_SMPR1_SMP6                 EQU 0x001c0000 ; SMP6
ADC_SMPR1_SMP6_ofs             EQU 18
ADC_SMPR1_SMP6_len             EQU 3
ADC_SMPR1_SMP5                 EQU 0x00038000 ; SMP5
ADC_SMPR1_SMP5_ofs             EQU 15
ADC_SMPR1_SMP5_len             EQU 3
ADC_SMPR1_SMP4                 EQU 0x00007000 ; SMP4
ADC_SMPR1_SMP4_ofs             EQU 12
ADC_SMPR1_SMP4_len             EQU 3
ADC_SMPR1_SMP3                 EQU 0x00000e00 ; SMP3
ADC_SMPR1_SMP3_ofs             EQU 9
ADC_SMPR1_SMP3_len             EQU 3
ADC_SMPR1_SMP2                 EQU 0x000001c0 ; SMP2
ADC_SMPR1_SMP2_ofs             EQU 6
ADC_SMPR1_SMP2_len             EQU 3
ADC_SMPR1_SMP1                 EQU 0x00000038 ; SMP1
ADC_SMPR1_SMP1_ofs             EQU 3
ADC_SMPR1_SMP1_len             EQU 3


; ADC1_SMPR2 fields:

ADC_SMPR2_SMP18                EQU 0x07000000 ; SMP18
ADC_SMPR2_SMP18_ofs            EQU 24
ADC_SMPR2_SMP18_len            EQU 3
ADC_SMPR2_SMP17                EQU 0x00e00000 ; SMP17
ADC_SMPR2_SMP17_ofs            EQU 21
ADC_SMPR2_SMP17_len            EQU 3
ADC_SMPR2_SMP16                EQU 0x001c0000 ; SMP16
ADC_SMPR2_SMP16_ofs            EQU 18
ADC_SMPR2_SMP16_len            EQU 3
ADC_SMPR2_SMP15                EQU 0x00038000 ; SMP15
ADC_SMPR2_SMP15_ofs            EQU 15
ADC_SMPR2_SMP15_len            EQU 3
ADC_SMPR2_SMP14                EQU 0x00007000 ; SMP14
ADC_SMPR2_SMP14_ofs            EQU 12
ADC_SMPR2_SMP14_len            EQU 3
ADC_SMPR2_SMP13                EQU 0x00000e00 ; SMP13
ADC_SMPR2_SMP13_ofs            EQU 9
ADC_SMPR2_SMP13_len            EQU 3
ADC_SMPR2_SMP12                EQU 0x000001c0 ; SMP12
ADC_SMPR2_SMP12_ofs            EQU 6
ADC_SMPR2_SMP12_len            EQU 3
ADC_SMPR2_SMP11                EQU 0x00000038 ; SMP11
ADC_SMPR2_SMP11_ofs            EQU 3
ADC_SMPR2_SMP11_len            EQU 3
ADC_SMPR2_SMP10                EQU 0x00000007 ; SMP10
ADC_SMPR2_SMP10_ofs            EQU 0
ADC_SMPR2_SMP10_len            EQU 3


; ADC1_TR1 fields:

ADC_TR1_HT1                    EQU 0x0fff0000 ; HT1
ADC_TR1_HT1_ofs                EQU 16
ADC_TR1_HT1_len                EQU 12
ADC_TR1_LT1                    EQU 0x00000fff ; LT1
ADC_TR1_LT1_ofs                EQU 0
ADC_TR1_LT1_len                EQU 12


; ADC1_TR2 fields:

ADC_TR2_HT2                    EQU 0x00ff0000 ; HT2
ADC_TR2_HT2_ofs                EQU 16
ADC_TR2_HT2_len                EQU 8
ADC_TR2_LT2                    EQU 0x000000ff ; LT2
ADC_TR2_LT2_ofs                EQU 0
ADC_TR2_LT2_len                EQU 8


; ADC1_TR3 fields:

ADC_TR3_HT3                    EQU 0x00ff0000 ; HT3
ADC_TR3_HT3_ofs                EQU 16
ADC_TR3_HT3_len                EQU 8
ADC_TR3_LT3                    EQU 0x000000ff ; LT3
ADC_TR3_LT3_ofs                EQU 0
ADC_TR3_LT3_len                EQU 8


; ADC1_SQR1 fields:

ADC_SQR1_SQ4                   EQU 0x1f000000 ; SQ4
ADC_SQR1_SQ4_ofs               EQU 24
ADC_SQR1_SQ4_len               EQU 5
ADC_SQR1_SQ3                   EQU 0x007c0000 ; SQ3
ADC_SQR1_SQ3_ofs               EQU 18
ADC_SQR1_SQ3_len               EQU 5
ADC_SQR1_SQ2                   EQU 0x0001f000 ; SQ2
ADC_SQR1_SQ2_ofs               EQU 12
ADC_SQR1_SQ2_len               EQU 5
ADC_SQR1_SQ1                   EQU 0x000007c0 ; SQ1
ADC_SQR1_SQ1_ofs               EQU 6
ADC_SQR1_SQ1_len               EQU 5
ADC_SQR1_L3                    EQU 0x0000000f ; L3
ADC_SQR1_L3_ofs                EQU 0
ADC_SQR1_L3_len                EQU 4


; ADC1_SQR2 fields:

ADC_SQR2_SQ9                   EQU 0x1f000000 ; SQ9
ADC_SQR2_SQ9_ofs               EQU 24
ADC_SQR2_SQ9_len               EQU 5
ADC_SQR2_SQ8                   EQU 0x007c0000 ; SQ8
ADC_SQR2_SQ8_ofs               EQU 18
ADC_SQR2_SQ8_len               EQU 5
ADC_SQR2_SQ7                   EQU 0x0001f000 ; SQ7
ADC_SQR2_SQ7_ofs               EQU 12
ADC_SQR2_SQ7_len               EQU 5
ADC_SQR2_SQ6                   EQU 0x000007c0 ; SQ6
ADC_SQR2_SQ6_ofs               EQU 6
ADC_SQR2_SQ6_len               EQU 5
ADC_SQR2_SQ5                   EQU 0x0000001f ; SQ5
ADC_SQR2_SQ5_ofs               EQU 0
ADC_SQR2_SQ5_len               EQU 5


; ADC1_SQR3 fields:

ADC_SQR3_SQ14                  EQU 0x1f000000 ; SQ14
ADC_SQR3_SQ14_ofs              EQU 24
ADC_SQR3_SQ14_len              EQU 5
ADC_SQR3_SQ13                  EQU 0x007c0000 ; SQ13
ADC_SQR3_SQ13_ofs              EQU 18
ADC_SQR3_SQ13_len              EQU 5
ADC_SQR3_SQ12                  EQU 0x0001f000 ; SQ12
ADC_SQR3_SQ12_ofs              EQU 12
ADC_SQR3_SQ12_len              EQU 5
ADC_SQR3_SQ11                  EQU 0x000007c0 ; SQ11
ADC_SQR3_SQ11_ofs              EQU 6
ADC_SQR3_SQ11_len              EQU 5
ADC_SQR3_SQ10                  EQU 0x0000001f ; SQ10
ADC_SQR3_SQ10_ofs              EQU 0
ADC_SQR3_SQ10_len              EQU 5


; ADC1_SQR4 fields:

ADC_SQR4_SQ16                  EQU 0x000007c0 ; SQ16
ADC_SQR4_SQ16_ofs              EQU 6
ADC_SQR4_SQ16_len              EQU 5
ADC_SQR4_SQ15                  EQU 0x0000001f ; SQ15
ADC_SQR4_SQ15_ofs              EQU 0
ADC_SQR4_SQ15_len              EQU 5


; ADC1_DR fields:

ADC_DR_regularDATA             EQU 0x0000ffff ; regularDATA
...
ADC_JSQR_JSQ4                  EQU 0x7c000000 ; JSQ4
ADC_JSQR_JSQ4_ofs              EQU 26
ADC_JSQR_JSQ4_len              EQU 5
ADC_JSQR_JSQ3                  EQU 0x01f00000 ; JSQ3
ADC_JSQR_JSQ3_ofs              EQU 20
ADC_JSQR_JSQ3_len              EQU 5
ADC_JSQR_JSQ2                  EQU 0x0007c000 ; JSQ2
ADC_JSQR_JSQ2_ofs              EQU 14
ADC_JSQR_JSQ2_len              EQU 5
ADC_JSQR_JSQ1                  EQU 0x00001f00 ; JSQ1
ADC_JSQR_JSQ1_ofs              EQU 8
ADC_JSQR_JSQ1_len              EQU 5
ADC_JSQR_JEXTEN                EQU 0x000000c0 ; JEXTEN
ADC_JSQR_JEXTEN_ofs            EQU 6
ADC_JSQR_JEXTEN_len            EQU 2
ADC_JSQR_JEXTSEL               EQU 0x0000003c ; JEXTSEL
ADC_JSQR_JEXTSEL_ofs           EQU 2
ADC_JSQR_JEXTSEL_len           EQU 4
ADC_JSQR_JL                    EQU 0x00000003 ; JL
ADC_JSQR_JL_ofs                EQU 0
ADC_JSQR_JL_len                EQU 2


; ADC1_OFR1 fields:

ADC_OFR1_OFFSET1_EN            EQU 0x80000000 ; OFFSET1_EN
ADC_OFR1_OFFSET1_EN_ofs        EQU 31
ADC_OFR1_OFFSET1_EN_len        EQU 1
ADC_OFR1_OFFSET1_CH            EQU 0x7c000000 ; OFFSET1_CH
ADC_OFR1_OFFSET1_CH_ofs        EQU 26
ADC_OFR1_OFFSET1_CH_len        EQU 5
ADC_OFR1_OFFSET1               EQU 0x00000fff ; OFFSET1
ADC_OFR1_OFFSET1_ofs           EQU 0
ADC_OFR1_OFFSET1_len           EQU 12


; ADC1_OFR2 fields:

ADC_OFR2_OFFSET2_EN            EQU 0x80000000 ; OFFSET2_EN
ADC_OFR2_OFFSET2_EN_ofs        EQU 31
ADC_OFR2_OFFSET2_EN_len        EQU 1
ADC_OFR2_OFFSET2_CH            EQU 0x7c000000 ; OFFSET2_CH
ADC_OFR2_OFFSET2_CH_ofs        EQU 26
ADC_OFR2_OFFSET2_CH_len        EQU 5
ADC_OFR2_OFFSET2               EQU 0x00000fff ; OFFSET2
ADC_OFR2_OFFSET2_ofs           EQU 0
ADC_OFR2_OFFSET2_len           EQU 12


; ADC1_OFR3 fields:

ADC_OFR3_OFFSET3_EN            EQU 0x80000000 ; OFFSET3_EN
ADC_OFR3_OFFSET3_EN_ofs        EQU 31
ADC_OFR3_OFFSET3_EN_len        EQU 1
ADC_OFR3_OFFSET3_CH            EQU 0x7c000000 ; OFFSET3_CH
ADC_OFR3_OFFSET3_CH_ofs        EQU 26
ADC_OFR3_OFFSET3_CH_len        EQU 5
ADC_OFR3_OFFSET3               EQU 0x00000fff ; OFFSET3
ADC_OFR3_OFFSET3_ofs           EQU 0
ADC_OFR3_OFFSET3_len           EQU 12


; ADC1_OFR4 fields:

ADC_OFR4_OFFSET4_EN            EQU 0x80000000 ; OFFSET4_EN
ADC_OFR4_OFFSET4_EN_ofs        EQU 31
ADC_OFR4_OFFSET4_EN_len        EQU 1
ADC_OFR4_OFFSET4_CH            EQU 0x7c000000 ; OFFSET4_CH
ADC_OFR4_OFFSET4_CH_ofs        EQU 26
ADC_OFR4_OFFSET4_CH_len        EQU 5
ADC_OFR4_OFFSET4               EQU 0x00000fff ; OFFSET4
ADC_OFR4_OFFSET4_ofs           EQU 0
ADC_OFR4_OFFSET4_len           EQU 12


; ADC1_JDR1 fields:

ADC_JDR1_JDATA1                EQU 0x0000ffff ; JDATA1
ADC_JDR1_JDATA1_ofs            EQU 0
ADC_JDR1_JDATA1_len            EQU 16


; ADC1_JDR2 fields:

ADC_JDR2_JDATA2                EQU 0x0000ffff ; JDATA2
ADC_JDR2_JDATA2_ofs            EQU 0
ADC_JDR2_JDATA2_len            EQU 16


; ADC1_JDR3 fields:

ADC_JDR3_JDATA3                EQU 0x0000ffff ; JDATA3
ADC_JDR3_JDATA3_ofs            EQU 0
ADC_JDR3_JDATA3_len            EQU 16


; ADC1_JDR4 fields:

ADC_JDR4_JDATA4                EQU 0x0000ffff ; JDATA4
ADC_JDR4_JDATA4_ofs            EQU 0
ADC_JDR4_JDATA4_len            EQU 16


; ADC1_AWD2CR fields:

ADC_AWD2CR_AWD2CH              EQU 0x0007fffe ; AWD2CH
ADC_AWD2CR_AWD2CH_ofs          EQU 1
ADC_AWD2CR_AWD2CH_len          EQU 18


; ADC1_AWD3CR fields:

ADC_AWD3CR_AWD3CH              EQU 0x0007fffe ; AWD3CH
ADC_AWD3CR_AWD3CH_ofs          EQU 1
ADC_AWD3CR_AWD3CH_len          EQU 18


; ADC1_DIFSEL fields:

ADC_DIFSEL_DIFSEL_1_15         EQU 0x0000fffe ; Differential mode for channels 15 to 1
ADC_DIFSEL_DIFSEL_1_15_ofs     EQU 1
ADC_DIFSEL_DIFSEL_1_15_len     EQU 15
ADC_DIFSEL_DIFSEL_16_18        EQU 0x00070000 ; Differential mode for channels 18 to 16
ADC_DIFSEL_DIFSEL_16_18_ofs    EQU 16
ADC_DIFSEL_DIFSEL_16_18_len    EQU 3


; ADC1_CALFACT fields:

ADC_CALFACT_CALFACT_D          EQU 0x007f0000 ; CALFACT_D
ADC_CALFACT_CALFACT_D_ofs      EQU 16
ADC_CALFACT_CALFACT_D_len      EQU 7
ADC_CALFACT_CALFACT_S          EQU 0x0000007f ; CALFACT_S
ADC_CALFACT_CALFACT_S_ofs      EQU 0
ADC_CALFACT_CALFACT_S_len      EQU 7
